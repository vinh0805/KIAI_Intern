                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @else
                                <li><a href="{{url('/logout-checkout')}}"><i class="fa fa-lock"></i> Logout</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <form action="{{url('/search')}}" method="post">
                        ...
                        <div class="search_box pull-right">
                            ...
                            <span><button type="submit" name="search_items" class="btn btn-default">Search</button></span>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="{{URL::to('/brand/' . $brand->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand->brand_name}}</a></li>
                            </ul>
                            @endforeach
                        </div>
                    </div><!--/brands_products-->
                ...
                <div class="col-sm-7">
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="{{('public/frontend/images/home/iframe2.p')}}ng" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
